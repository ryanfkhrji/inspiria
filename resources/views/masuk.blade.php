...
<body>
  <!-- Hero Section start -->
  <section id="beranda" class="bg-bgCream">
      ...
      <div class="flex w-full h-screen">
        ...
        <div class="w-full flex items-center justify-start lg:w-1/2 px-2 md:px-6">
          <div class="bg-white px-6 w-full rounded-sm">
            <h1 class="text-center py-8 text-xl text-primary">Selamat Datang Di <span class="font-bold">Inspiria<span class="text-secondary">.</span></span></h1>
            <div class="w-full">
              <div>
                <form action="/masuk" method="POST">
                  ...
                  <button class="w-full bg-secondary text-white mt-10 mb-8 py-4 rounded" type="submit" id="masuk">Masuk</button>
                </form>
              </div>
            </div>
          </div>
